...
export default class Responsivesidebar extends CustomElement {
    render({ html, state }) {
        return html`<style>
...
if (!customElements.get("e-responsive-sidebar")) { customElements.define("e-responsive-sidebar", Responsivesidebar) };
