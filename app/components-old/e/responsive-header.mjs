...
export default class Responsiveheader extends CustomElement {
    render({ html, state }) {
        return html`export default function eNavBar({ html, state }) {
...
if (!customElements.get("e-responsive-header")) { customElements.define("e-responsive-header", Responsiveheader) };
